...
class Product(models.Model):
    product = models.CharField(primary_key= True, max_length= 200)
...
class Task(models.Model):
    ...
    product = models.ForeignKey(Product, related_name= 'tasks', on_delete=models.CASCADE, null=True, blank= True)
